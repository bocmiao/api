  ...
  routes: [
    {
      ...
      fields: [
        ...
        { name: 'location', type: 'object|null', desc: `IP 归属地（来自 ip-api.com，缓存 6 小时）。内网/保留地址、参数 geo=0、查询失败或超过 ${GEO_TIMEOUT_MS / 1000} 秒未返回时为 null，不会报错` },
        ...
        { name: 'location.isp', type: 'string|null', desc: '运营商/ISP 名称（上游多为英文，如 Chinanet）；未返回时为 null' },
